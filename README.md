...
1. **Download the script:**
   ```bash
   wget https://raw.githubusercontent.com/skorches/wireguard-vpn/main/wireguard-setup.sh
   # or
   curl -O https://raw.githubusercontent.com/skorches/wireguard-vpn/main/wireguard-setup.sh
   ```
